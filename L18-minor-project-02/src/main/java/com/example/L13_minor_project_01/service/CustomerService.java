...
public class CustomerService {
    ...
    public CustomerService(ProductRepository productRepository, OrderRepository orderRepository, OrderItemRepository orderItemRepository, RedisTemplate<String, ProductResponseDto> redisTemplate) {
    ...
    public ProductResponseDto getProductById(Long id) {
        ...
        ProductResponseDto productResponseDto = redisTemplate.opsForValue().get(key);
        if(productResponseDto == null) {
            productResponseDto = productRepository.findById(id)
                    .map(this::mapToProductResponse)
                    .orElseThrow(() -> new ResourceNotFoundException("Product not found with id: " + id));
            redisTemplate.opsForValue().set(key,productResponseDto);
        }
